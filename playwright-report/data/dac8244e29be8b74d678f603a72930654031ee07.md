...
- Name: cross-browser-rendering.spec.ts >> 11 — documented cross-browser rendering differences >> overscroll-behavior serialisation varies by engine but effect is consistent
- Location: e2e/cross-browser-rendering.spec.ts:815:7
