...
- Name: cross-browser-rendering.spec.ts >> 4 — CSS animations >> score-flash animation class is present on current-score span
- Location: e2e/cross-browser-rendering.spec.ts:315:7
