...
- Name: cross-browser-rendering.spec.ts >> 5 — game controls rendering >> Reset button is visible but disabled in IDLE
- Location: e2e/cross-browser-rendering.spec.ts:427:7
