...
- Name: cross-browser-rendering.spec.ts >> 2 — score board rendering >> status badge switches to bg-green-500 when PLAYING
- Location: e2e/cross-browser-rendering.spec.ts:184:7
