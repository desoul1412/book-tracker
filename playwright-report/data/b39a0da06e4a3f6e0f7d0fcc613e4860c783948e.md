...
- Name: cross-browser-rendering.spec.ts >> 8 — requestAnimationFrame stability >> no JS errors after starting and pausing the game
- Location: e2e/cross-browser-rendering.spec.ts:674:7
