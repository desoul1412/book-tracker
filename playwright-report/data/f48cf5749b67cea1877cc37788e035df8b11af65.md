...
- Name: cross-browser-rendering.spec.ts >> 3 — game board canvas rendering >> canvas element is present inside the game-board wrapper
- Location: e2e/cross-browser-rendering.spec.ts:228:7
