...
- Name: cross-browser-rendering.spec.ts >> 2 — score board rendering >> status badge renders with bg-gray-500 class in IDLE
- Location: e2e/cross-browser-rendering.spec.ts:175:7
