...
- Name: cross-browser-rendering.spec.ts >> 7 — full game lifecycle (keyboard driven) >> arrow key does not crash the game (RIGHT from initial RIGHT heading)
- Location: e2e/cross-browser-rendering.spec.ts:564:7
