...
- Name: cross-browser-rendering.spec.ts >> 1 — page structure and dark background >> body has overscroll-behavior: none (prevent pull-to-refresh on mobile)
- Location: e2e/cross-browser-rendering.spec.ts:130:7
