...
- Name: cross-browser-rendering.spec.ts >> 7 — full game lifecycle (keyboard driven) >> Reset button returns game to IDLE from RUNNING
- Location: e2e/cross-browser-rendering.spec.ts:553:7
