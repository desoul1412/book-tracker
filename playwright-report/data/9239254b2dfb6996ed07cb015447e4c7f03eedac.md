...
- Name: cross-browser-rendering.spec.ts >> 7 — full game lifecycle (keyboard driven) >> Space pauses a running game
- Location: e2e/cross-browser-rendering.spec.ts:535:7
