...
- Name: cross-browser-rendering.spec.ts >> 7 — full game lifecycle (keyboard driven) >> Space resumes a paused game
- Location: e2e/cross-browser-rendering.spec.ts:543:7
