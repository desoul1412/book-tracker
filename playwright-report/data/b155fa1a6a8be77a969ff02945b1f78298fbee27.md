...
- Name: cross-browser-rendering.spec.ts >> 6 — keyboard hints visibility >> keyboard hints are visible in IDLE state
- Location: e2e/cross-browser-rendering.spec.ts:504:7
