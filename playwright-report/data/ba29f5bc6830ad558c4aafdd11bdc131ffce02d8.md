...
- Name: cross-browser-rendering.spec.ts >> 8 — requestAnimationFrame stability >> no JS errors thrown on initial load
- Location: e2e/cross-browser-rendering.spec.ts:665:7
