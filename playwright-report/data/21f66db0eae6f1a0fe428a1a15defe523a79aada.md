...
- Name: cross-browser-rendering.spec.ts >> 8 — requestAnimationFrame stability >> canvas pixel dimensions remain non-zero after window resize
- Location: e2e/cross-browser-rendering.spec.ts:685:7
