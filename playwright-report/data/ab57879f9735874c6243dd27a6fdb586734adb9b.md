...
- Name: cross-browser-rendering.spec.ts >> 11 — documented cross-browser rendering differences >> backdrop-blur Tailwind class is present (implementation is browser-delegated)
- Location: e2e/cross-browser-rendering.spec.ts:870:7
