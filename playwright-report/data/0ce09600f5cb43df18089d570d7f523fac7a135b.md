...
- Name: cross-browser-rendering.spec.ts >> 10 — mobile layout and responsive canvas >> heading remains visible without horizontal scroll on 375 px viewport
- Location: e2e/cross-browser-rendering.spec.ts:768:7
