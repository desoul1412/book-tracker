...
- Name: cross-browser-rendering.spec.ts >> 10 — mobile layout and responsive canvas >> game board fills available width on narrow viewport (375 px)
- Location: e2e/cross-browser-rendering.spec.ts:754:7
