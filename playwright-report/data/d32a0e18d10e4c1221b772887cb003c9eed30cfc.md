...
- Name: cross-browser-rendering.spec.ts >> 1 — page structure and dark background >> main element contains the game heading
- Location: e2e/cross-browser-rendering.spec.ts:123:7
