...
- Name: cross-browser-rendering.spec.ts >> 5 — game controls rendering >> Pause button touch target: documents actual height (WCAG finding, ~21 px)
- Location: e2e/cross-browser-rendering.spec.ts:478:7
