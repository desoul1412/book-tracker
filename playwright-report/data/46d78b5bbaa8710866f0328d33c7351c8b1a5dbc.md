...
- Name: cross-browser-rendering.spec.ts >> 10 — mobile layout and responsive canvas >> game controls are visible on mobile viewport without overflow
- Location: e2e/cross-browser-rendering.spec.ts:786:7
