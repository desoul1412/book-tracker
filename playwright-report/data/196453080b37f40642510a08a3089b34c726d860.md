...
- Name: cross-browser-rendering.spec.ts >> 5 — game controls rendering >> Start button is visible and enabled in IDLE
- Location: e2e/cross-browser-rendering.spec.ts:420:7
