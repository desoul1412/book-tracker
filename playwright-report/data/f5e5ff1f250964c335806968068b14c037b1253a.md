...
- Name: cross-browser-rendering.spec.ts >> 3 — game board canvas rendering >> canvas background colour is gray-950 (#030712) via wrapper inline style
- Location: e2e/cross-browser-rendering.spec.ts:295:7
