...
- Name: cross-browser-rendering.spec.ts >> 7 — full game lifecycle (keyboard driven) >> 180-degree reversal (ArrowLeft from RIGHT) is dropped — no crash
- Location: e2e/cross-browser-rendering.spec.ts:579:7
