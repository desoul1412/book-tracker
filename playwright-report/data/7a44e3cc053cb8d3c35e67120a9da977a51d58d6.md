...
- Name: cross-browser-rendering.spec.ts >> 3 — game board canvas rendering >> canvas has aria-hidden=true (decorative to screen readers)
- Location: e2e/cross-browser-rendering.spec.ts:236:7
