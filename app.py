            ...
            if st.form_submit_button("Add Book", type="primary"):
                try:
                    ...
                    mapping = {
                        ...
                        "Author": n_author, "Title": n_title, "Reading Status": n_status, "Cover URL": n_cover
                    }
    ...
    try:
        ...
        with tab_shelf:
            ...
            with s1:
                ...
                search_choice = st.selectbox("🔎 Search Book (Suggestion):", [""] + all_titles)
                if search_choice: filtered_df = filtered_df[filtered_df[col_map["T"]] == search_choice]
            with s2:
                sort_opt = st.selectbox("Sort By:", ["Newest Added", "Title (A-Z)", "Title (Z-A)"])
            ...
            def show_modal(row):
                ...
                with c2:
                    ...
                    new_rev = st.text_area("Reviews", value=row[col_map["Rev"]], height=200)
                    cd, cs = st.columns(2)
