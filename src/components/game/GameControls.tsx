  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={onStart}
        className={`${BASE_BUTTON} bg-green-600 text-white hover:bg-green-500 focus-visible:ring-green-500`}
      >
        Start
      </button>
      ...
      {isRunning && (
        <button
          ...
          onClick={onPause}
          className={`${BASE_BUTTON} bg-yellow-600 text-white hover:bg-yellow-500 focus-visible:ring-yellow-500`}
        >
          Pause
        </button>
      )}
      ...
      {isPaused && (
        <button
          ...
          onClick={onResume}
          className={`${BASE_BUTTON} bg-blue-600 text-white hover:bg-blue-500 focus-visible:ring-blue-500`}
        >
          Resume
        </button>
      )}
      ...
      <button
        ...
        onClick={onReset}
        className={`${BASE_BUTTON} bg-red-600 text-white hover:bg-red-500 focus-visible:ring-red-500`}
      >
        Reset
      </button>
    </div>
