...
export const GameOverOverlay: FC<GameOverOverlayProps> = ({
  ...
  return (
    <div
      className="absolute inset-0 flex animate-[fadeIn_0.3s_ease-out] items-center justify-center bg-black/75 backdrop-blur-md"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div
        className="flex flex-col items-center gap-6 rounded-2xl border border-red-900/40 bg-gray-950/95 px-10 py-8 shadow-2xl"
        style={{ boxShadow: "0 0 0 1px rgba(239,68,68,0.15), 0 0 40px rgba(239,68,68,0.1)" }}
      >
        {/* ── Title ──────────────────────────────────────────────────────── */}
        <h2
          id="game-over-title"
        ...
        <div className="flex gap-10 text-center text-white">
          <div className="flex flex-col items-center">
            ...
            <span
              className="text-3xl font-bold tabular-nums text-green-300"
        ...
        <button
          type="button"
          className="mt-2 rounded-lg bg-green-600 px-8 py-3 text-base font-bold text-white transition-all hover:bg-green-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-400 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-950"
          style={{ boxShadow: "0 0 16px rgba(74,222,128,0.4)" }}
          onClick={onPlayAgain}
