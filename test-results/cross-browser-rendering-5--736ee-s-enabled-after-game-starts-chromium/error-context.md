...
- Name: cross-browser-rendering.spec.ts >> 5 — game controls rendering >> Reset button becomes enabled after game starts
- Location: e2e/cross-browser-rendering.spec.ts:455:7
