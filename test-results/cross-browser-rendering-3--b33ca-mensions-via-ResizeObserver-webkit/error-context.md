...
- Name: cross-browser-rendering.spec.ts >> 3 — game board canvas rendering >> canvas is sized to the wrapper dimensions via ResizeObserver
- Location: e2e/cross-browser-rendering.spec.ts:255:7
