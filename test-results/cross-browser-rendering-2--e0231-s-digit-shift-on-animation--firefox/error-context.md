...
- Name: cross-browser-rendering.spec.ts >> 2 — score board rendering >> score label has tabular-nums Tailwind class (prevents digit shift on animation)
- Location: e2e/cross-browser-rendering.spec.ts:203:7
