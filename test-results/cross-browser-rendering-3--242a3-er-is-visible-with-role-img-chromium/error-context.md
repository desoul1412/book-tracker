...
- Name: cross-browser-rendering.spec.ts >> 3 — game board canvas rendering >> game-board wrapper is visible with role=img
- Location: e2e/cross-browser-rendering.spec.ts:221:7
