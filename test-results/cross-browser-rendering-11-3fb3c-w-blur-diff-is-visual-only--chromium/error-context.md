...
- Name: cross-browser-rendering.spec.ts >> 11 — documented cross-browser rendering differences >> canvas element is present in all browsers (shadow-blur diff is visual-only)
- Location: e2e/cross-browser-rendering.spec.ts:844:7
