...
- Name: cross-browser-rendering.spec.ts >> 11 — documented cross-browser rendering differences >> canvas reaches non-zero size within 5 s (ResizeObserver timing tolerance)
- Location: e2e/cross-browser-rendering.spec.ts:914:7
