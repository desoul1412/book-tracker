...
- Name: cross-browser-rendering.spec.ts >> 3 — game board canvas rendering >> game-board wrapper maintains aspect-ratio CSS (square-ish grid)
- Location: e2e/cross-browser-rendering.spec.ts:282:7
