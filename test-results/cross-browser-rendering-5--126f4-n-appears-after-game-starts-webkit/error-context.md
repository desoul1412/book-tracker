...
- Name: cross-browser-rendering.spec.ts >> 5 — game controls rendering >> Pause button appears after game starts
- Location: e2e/cross-browser-rendering.spec.ts:448:7
