...
- Name: cross-browser-rendering.spec.ts >> 4 — CSS animations >> @keyframes score-flash is defined in the document stylesheets
- Location: e2e/cross-browser-rendering.spec.ts:326:7
