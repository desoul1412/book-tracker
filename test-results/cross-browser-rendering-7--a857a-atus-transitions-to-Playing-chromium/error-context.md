...
- Name: cross-browser-rendering.spec.ts >> 7 — full game lifecycle (keyboard driven) >> Enter starts the game and status transitions to Playing
- Location: e2e/cross-browser-rendering.spec.ts:526:7
