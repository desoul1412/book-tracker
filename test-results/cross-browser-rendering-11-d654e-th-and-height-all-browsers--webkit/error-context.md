...
- Name: cross-browser-rendering.spec.ts >> 11 — documented cross-browser rendering differences >> game board aspect-ratio results in equal width and height (all browsers)
- Location: e2e/cross-browser-rendering.spec.ts:942:7
