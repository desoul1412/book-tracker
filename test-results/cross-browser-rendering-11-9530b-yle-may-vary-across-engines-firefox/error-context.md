...
- Name: cross-browser-rendering.spec.ts >> 11 — documented cross-browser rendering differences >> tabular-nums CSS class is present; computed style may vary across engines
- Location: e2e/cross-browser-rendering.spec.ts:969:7
