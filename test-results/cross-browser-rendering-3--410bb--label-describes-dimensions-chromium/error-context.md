...
- Name: cross-browser-rendering.spec.ts >> 3 — game board canvas rendering >> game-board wrapper aria-label describes dimensions
- Location: e2e/cross-browser-rendering.spec.ts:244:7
