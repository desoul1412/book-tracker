...
- Name: cross-browser-rendering.spec.ts >> 4 — CSS animations >> food pulse rAF loop paints the canvas background within 5 s
- Location: e2e/cross-browser-rendering.spec.ts:369:7
