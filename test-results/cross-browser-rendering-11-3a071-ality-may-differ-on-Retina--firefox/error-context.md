...
- Name: cross-browser-rendering.spec.ts >> 11 — documented cross-browser rendering differences >> heading text-shadow is applied (rendering quality may differ on Retina)
- Location: e2e/cross-browser-rendering.spec.ts:890:7
