...
- Name: cross-browser-rendering.spec.ts >> 5 — game controls rendering >> Start button becomes disabled after game starts
- Location: e2e/cross-browser-rendering.spec.ts:441:7
